<?php
$page_title = 'Request/Approve Logs';
...
$total_items_data = count_requests_log($search_query);
...
$logs = join_requests_log($items_per_page, $offset, $search_query);
...
<div class="row">
    ...
    <h1><b>REQUESTS LOGS</b></h1>
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading clearfix">
                <form action="requests_log.php" method="GET" class="form-inline pull-left">
                    ...
                    <a href="requests_log.php" class="btn btn-danger">Reset</a>
                </form>
            </div>
                            ...
                            <?php else: ?>
                                <?php foreach ($logs as $index=> $log): ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?php echo remove_junk($log['request_by']); ?></td>
                                        <td class="text-center"><?php echo remove_junk($log['quantity']); ?></td>
                                        <td class="text-center"><?php echo read_date($log['date_request']); ?></td>
